...
Default address is `10.0.0.0` (can be changed with `vpc_address` variable) and VPC netmask is `/24`.
Subnets are as follows (`<cluster>` defaults to `main` and can be changed with `cluster_name` variable):
